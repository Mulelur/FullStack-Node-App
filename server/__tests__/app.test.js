...
describe('GET /customer', () => {
  describe('Get a customer if already exits', () => {
    it('should  give a 200 status response', async () => {
      await request(app).get('/customer/:name').expect(200);
    });
    // it('should retrun a json response').expect('Content-Type', /json/);
  });
});
